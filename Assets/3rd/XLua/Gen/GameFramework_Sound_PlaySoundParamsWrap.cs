...
namespace XLua.CSObjectWrap
{
    ...
    public class GameFrameworkSoundPlaySoundParamsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameFramework.Sound.PlaySoundParams);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					GameFramework.Sound.PlaySoundParams gen_ret = new GameFramework.Sound.PlaySoundParams();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameFramework.Sound.PlaySoundParams constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        GameFramework.Sound.PlaySoundParams gen_ret = GameFramework.Sound.PlaySoundParams.Create(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                GameFramework.Sound.PlaySoundParams gen_to_be_invoked = (GameFramework.Sound.PlaySoundParams)translator.FastGetCSObj(L, 1);
