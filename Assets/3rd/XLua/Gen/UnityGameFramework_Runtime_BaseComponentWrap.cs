    ...
    public class UnityGameFrameworkRuntimeBaseComponentWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.BaseComponent gen_ret = new UnityGameFramework.Runtime.BaseComponent();
        ...
        static int _m_PauseGame(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.BaseComponent gen_to_be_invoked = (UnityGameFramework.Runtime.BaseComponent)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_EditorLanguage(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.BaseComponent gen_to_be_invoked = (UnityGameFramework.Runtime.BaseComponent)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.EditorLanguage);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_EditorResourceHelper(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.BaseComponent gen_to_be_invoked = (UnityGameFramework.Runtime.BaseComponent)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.EditorResourceHelper);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_EditorResourceHelper(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.BaseComponent gen_to_be_invoked = (UnityGameFramework.Runtime.BaseComponent)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.EditorResourceHelper = (GameFramework.Resource.IResourceManager)translator.GetObject(L, 2, typeof(GameFramework.Resource.IResourceManager));
